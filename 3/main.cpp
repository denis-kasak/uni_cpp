...
int main()
{
    ...
    // A: In der Rückgabe der ones()-Funktion

    // Wieso kann die Funktion ones() mit dem Scope-Operator, ohne Objekt aufgerunfen werden?
    // A: Da die ones()-Funktion als statisch deklariert ist
    ...
    Matrix33 matResult3 = matA * (double)5;
    ...
    Matrix33 matResult4 = (double)5 * matA;
    std::cout << matResult4.toString() << std::endl;

    // Warum funktioniert die Anweisung nicht? L�sen Sie das Problem!
    // A: Weil die Operator Überladung nur mit Matrix33 * double funktioniert. Reihenfolge ist wichtig.
